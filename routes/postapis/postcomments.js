...
router.patch('/:id', getVendor, async (req, res) => {
    ...
    console.log(res.required__object.Videos.Comments)
    res.required__object.Videos.Comments.unshift({
        "User_id":"Thanks manali",
        "Comment":"adfadsaad"
    })
  
    try {   
      const updatedComment = await res.required__object.save()
